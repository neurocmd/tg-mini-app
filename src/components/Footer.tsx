  ...
  return (
    <footer className="pointer-events-none absolute inset-x-0 bottom-0 isolate z-1000 p-3 pb-[calc(theme(spacing.3)+var(--safe-area-inset-bottom))]">
      <div className="glass pointer-events-auto rounded-3xl">
        <nav className="grid grid-cols-3 p-1.5">
          <Link
            href="/rating"
            className="relative isolate flex h-16.25 cursor-pointer flex-col items-center justify-center rounded-3xl px-4 py-1 font-bold"
          >
          ...
          <Link
            href="/play"
            className="flex h-16.25 cursor-pointer flex-col items-center justify-center rounded-3xl px-4 py-1 font-bold text-white/50 transition"
          >
